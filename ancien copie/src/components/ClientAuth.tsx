...
import { Lock, Mail, User, Building, ChevronRight, AlertCircle, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-mono flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-500 text-sm tracking-wider">CLIENT PORTAL</p>
        </div>
        ...
        <div className="terminal-box mb-6">
          ...
          {successMessage && (
            <div className="mb-4 p-3 bg-emerald-950/50 border border-emerald-600 rounded-sm">
        ...
        <div className="text-center text-zinc-500 text-xs">
          ...
          <p className="mt-1">SECURE CLIENT ACCESS PORTAL</p>
        </div>
      </div>
    </div>
  );
